...
public class PurchaseRequisitionPage extends javax.swing.JFrame {
     ...
     */
    public PurchaseRequisitionPage(LoginSession loginSession) {
    ...
    private void btnBack2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBack2ActionPerformed
        // TODO add your handling code here:
        Main_menu_PM menu = new Main_menu_PM(); // Create an instance of ViewItemForm
        menu.setVisible(true); // Make ViewItemForm visible
    this.dispose();
...
LoginSession loginSession = new LoginSession();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PurchaseRequisitionPage(loginSession).setVisible(true);
            }
        });
    }
